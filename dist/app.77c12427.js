...
exports.find = exports.checkValidHash = void 0;
...
exports.checkValidHash = checkValidHash;
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/js/config.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/js/dataFetching.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchUser = exports.fetchPost = void 0;
...
var fetchPost = function fetchPost() {
  var data = _axios.default.get("".concat(_config.BASE_URL, "/posts"));
...
var fetchUser = function fetchUser() {
  var data = _axios.default.get("".concat(_config.BASE_URL, "/users"));
...
},{"axios":"node_modules/axios/index.js","./config":"src/js/config.js"}],"src/js/app.js":[function(require,module,exports) {
"use strict";

var _utility = require("./utility");

var _dataFetching = require("./dataFetching");

var home = (0, _utility.find)("#home");
var allPost = (0, _utility.find)("#allPost");
var fullPost = (0, _utility.find)("#fullPost"); // home page rendering
...
var renderAllPost = function renderAllPost() {
  allPost.style.display = "block";
}; // fullPost rendering


var renderFullPost = function renderFullPost() {
  fullPost.style.display = "block";
}; // rendring HTML according to condition


var renderHtml = function renderHtml(hashValue) {
  if (hashValue === "#home") {
    allPost.style.display = "none";
    fullPost.style.display = "none";
    (0, _dataFetching.fetchPost)();
    (0, _dataFetching.fetchUser)();
    renderHome();
...
init();
},{"./utility":"src/js/utility.js","./dataFetching":"src/js/dataFetching.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
